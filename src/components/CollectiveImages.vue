...
<template>
  <div>
    <div
      v-if="showAlert"
      class="alert fs-6 text-white mb-3 d-flex align-items-center justify-content-between collective-images__alert"
      :class="alertType === 'success' ? 'bg-positivo-e' : 'bg-negativo-e'"
      role="alert"
    >
